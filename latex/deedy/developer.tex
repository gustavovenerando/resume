...
\begin{tightemize}
    \item Aplicação React para Locação de Imóveis para passeio na cidade de Ubatuba-SP.
\end{tightemize}\sectionsep

\runsubsection{Self 42}
...
\location{Junho 2022}
\begin{tightemize}
    \item Aplicação React para realizacao de cadastro de tecnologias.
\end{tightemize}\sectionsep
